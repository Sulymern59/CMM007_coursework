		...
		<div class="col-md-10 content">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
					<form class="form-group" method="POST" action="edit2.php?exid=<?php echo $_GET['exid'];?>">
						<fieldset>
...
<p>Ethical principles normally apply to information, data, and derivative substances in the same way as they apply to the subjects themselves. Consequently, work with individual financial data is governed by the principles of work with individual human subjects, and work with animal tissue is governed by the principles of work with animals.</p>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
						...
						<div class="form-group"><p>(a)	individual human subjects<input type="radio" name="q1a"  value="NO" style="float: right"  <?php if ($row['q1a'] == 'NO') echo 'checked="checked"'; ?>"><input type="radio" name="q1a" value="YES" style="float: right;  margin-right: 30px"  <?php if ($row['q1a'] == 'YES') echo 'checked="checked"'; ?>> </p></div>
						<div class="form-group"> <p>(b)	groups (e.g. families, communities, crowds)<input type="radio" name="q1b" value="NO" <?php if ($row['q1b'] == 'NO') echo 'checked="checked"'; ?> style="float: right;"><input type="radio" name="q1b" value="YES" <?php if ($row['q1b'] == 'YES') echo 'checked="checked"'; ?> style="float: right;  margin-right: 30px"></p></div>
						<div class="form-group"><p>(c)	organisations<input type="radio" name="q1c" value="NO" <?php if ($row['q1c'] == 'NO') echo 'checked="checked"'; ?> style="float: right;"><input type="radio" name="q1c" value="YES" <?php if ($row['q1c'] == 'YES') echo 'checked="checked"'; ?> style="float: right;  margin-right: 30px"></p></div>
						<div class="form-group"><p>(d)	animals?<input type="radio" name="q1d" value="NO" <?php if ($row['q1d'] == 'NO') echo 'checked="checked"'; ?> style="float: right;"><input type="radio" name="q1d" value="YES" <?php if ($row['q1d'] == 'YES') echo 'checked="checked"'; ?> style="float: right;  margin-right: 30px"></p></div>
						<div class="form-group"><p>(e)	genetically-modified organisms <a href="www.rgu.ac.uk/hr/healthsafety/page.cfm?pge=26027#122628">Guide</a><input type="radio" name="q1e" value="NO" <?php if ($row['q1e'] == 'NO') echo 'checked="checked"'; ?> style="float: right;"><input type="radio" name="q1e" value="YES" <?php if ($row['q1e'] == 'YES') echo 'checked="checked"'; ?>  style="float: right;  margin-right: 30px"> </p></div>
						<h5>Please provide further details:</h5>
						<textarea rows="5" cols="142" name="q1com"><?php echo $row['q1com']?></textarea>
						<hr>
						<div class="form-group">
						<div class="form-group"><label style="float: right;">NO</label>
						<input type="radio" name="q2a" value="NO" <?php if ($row['q2a'] == 'NO') echo 'checked="checked"'; ?>  style="float: right; margin-left: 10px;"></div>
						<div class="form-group"></div><label style="float: right;">YES</label>
						<input type="radio" name="q2a" value="YES" <?php if ($row['q2a'] == 'YES') echo 'checked="checked"'; ?>  style="float: right;"></div>
...
<p>The information obtained in research is not, however, necessarily private. Some material is in the public sphere, which includes published and broadcast material, academic discourse, and the activities of government. <br>Activities undertaken in a public place are public, rather than private, if they are openly displayed (e.g. artistic exhibition or attendance at a public event) or subject to public regulation (e.g. driving).”
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
						...
						<div class="form-group">
						<h5>Please provide further details:</h5>
						<textarea rows="5" cols="142" name="q2com"><?php echo $row['q2com']?></textarea>
						</div>
